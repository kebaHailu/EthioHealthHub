...
import imag from '../../images/features/eye.jpg'
            ...
            .map((_item, id) => (
              <div className="col-lg-4 col-md-6 col-sm-6" key={id + 3}>
                <div className="card shadow border-0 mb-5">
                  ...
                  />
                  <div className="p-2">
                    <h4 className="mt-4 mb-2">Skin Care</h4>
                    <p className="mb-4">
                     we provide 7 diffrent type of skin dieases with support of Ai
                    </p>
                  </div>
                </div>
              </div>
            ...
            .map((_item, id) => (
              <div className="col-lg-4 col-md-6 col-sm-6" key={id + 3}>
                <div className="card shadow border-0 mb-5">
                  ...
                  />
                  <div className="p-2">
                    <h4 className="mt-4 mb-2"> Eye Dieases</h4>
                    <p className="mb-4">
                     we have special treatment for 8 diffrent eye dieases
                  .
                    </p>
                  </div>
                </div>
