        ...
        <>
            <nav id="navbar" className="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><NavLink to={'/stations'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Stations</NavLink></li>
            ...
            >
                <ul className="mobile-menu-nav">
                    ...
                    <li><NavLink to={'/stations'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}><FaBloggerB className="icon" />Stations</NavLink></li>
